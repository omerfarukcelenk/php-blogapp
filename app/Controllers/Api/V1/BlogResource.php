...
class BlogResource extends ResourceController
{
    ...
    public function new()
    {
        $blogs = [
            ...
            ['id' => 6, 'title' => 'Blog 6', 'desc' => 'Blog 6 Özet'],
        ];
    ...
    public function edit($id = null)
    {
        ...
        $blogs = [
            ['id' => 0, 'title' => 'Blog 1', 'desc' => 'Blog 1 Özet'],
            ['id' => 1, 'title' => 'Blog 2', 'desc' => 'Blog 2 Özet'],
            ['id' => 2, 'title' => 'Blog 3', 'desc' => 'Blog 3 Özet'],
            ['id' => 3, 'title' => 'Blog 4', 'desc' => 'Blog 4 Özet'],
            ['id' => 4, 'title' => 'Blog 5', 'desc' => 'Blog 5 Özet'],
            ['id' => 5, 'title' => 'Blog 6', 'desc' => 'Blog 6 Özet'],
        ];
